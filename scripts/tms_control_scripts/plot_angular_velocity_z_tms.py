...
def plot_data():
    ...
    fig.canvas.set_window_title("plot_angular_velocity_z_tms.py")
    fig.suptitle("")
    ax[0].set_title("First TMS heading - angular velocity in z axis")
    ax[0].set_ylabel("angular velocity (rad/sec)")
    ax[0].set_xlabel("simulation time (sec)")
    ax[0].grid()
    ax[0].legend(loc = "upper left")
    
    ax[1].set_title("Second TMS heading - angular velocity in z axis")

...
# This code indirectly recieves data from ls_two_pc_rov.py, by subscribing to the /rov/sonar/pointcloud topic
...
if __name__ == "__main__":
    ...
    rospy.Subscriber("/rov/sonar/pointcloud",PointCloud2,pc_callback, center_pub)
